...
while cap.isOpened():
    ...
    # //hershey_complex
    # FONT_HERESHEY_COMPLEX/FONT_HERESHEY_COMPLEX
    # cv2.putText(img,"Out put text",(10,10),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,0,255),1,cv2.LINE_AA)
    # cv2.rectangle(img,(letx,lefty),(bootx,booty),color,size)
    # 按下 'n' 新建存储人脸的文件夹
    if kk == ord('n'):
        person_cnt += 1
