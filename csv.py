...
def return_128d_features(path_img):
    ...
    if len(faces) != 0:
        ...
        print("Got Face Preditor Shape returen is = ",type(shape))
    ...
    print("128 Dimension is = ",face_descriptor)
...
def compute_the_mean(path_csv_rd):
    ...
    for feature_num in range(128):
        ...
        print("tmp_arr = ",tmp_arr[0:])
        print("==================================================")
        tmp_arr = np.array(tmp_arr)
        print("after np.arr = ",tmp_arr)
        print("************************************************")
        # 计算某一个特征的均值
    ...
    print("Final return feature_mean is = ",feature_mean)
    return feature_mean
